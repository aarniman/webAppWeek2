...
const userLocation = [24.941244, 60.171987];

restaurants.forEach(restaurant => {
  restaurant.distance = calculateDistance(restaurant.location.coordinates, userLocation);
});
...
function displayRestaurants() {
  ...
  restaurants.forEach(restaurant => {
    ...
    row.insertCell(1).textContent = restaurant.address + ', ' + restaurant.postalCode + ' ' + restaurant.city;
    row.insertCell(2).textContent = (restaurant.distance*100).toFixed(2) + ' km';
  });
}
